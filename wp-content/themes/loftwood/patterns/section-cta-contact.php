...
<section class="bg-warm-white" style="padding-top: var(--section-gap); padding-bottom: var(--section-gap);">
    <div class="max-w-[800px] mx-auto px-6 text-center" data-reveal="scale">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="tel:<?php echo esc_attr(preg_replace('/\s+/', '', $phone)); ?>" class="inline-flex items-center px-8 py-4 border-2 border-slate/20 text-foreground font-semibold rounded hover:border-bronze hover:text-bronze transition-colors">
